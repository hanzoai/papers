...
\midrule
Deserialize & 21 ns & 3,231 ns & 157$\times$ \\
Serialize & 266 ns & 4,221 ns & 16$\times$ \\
Consensus vote & 539 ns & 5,255 ns & 10$\times$ \\
DAG vertex & 571 ns & 4,806 ns & 8$\times$ \\
\bottomrule
\end{tabular}
\caption{ZAP vs.\ Protobuf wire protocol benchmarks.}
\label{tab:wire-perf}
\end{table}
...
\bibitem{signoz} Hanzo O11y (SigNoz fork), ``Unified Observability Platform,'' 2024.

\bibitem{posthog} Hanzo Insights (PostHog fork), ``Behavioral Analytics Platform,'' 2024.
