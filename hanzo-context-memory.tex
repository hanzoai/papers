...
on both columns pooled, and we make no claim against it beyond that. Pith's
reported 68 on multi-hop at 262K is not reached: the 262K column is where the
remaining error is, and \texttt{mab/oracle.mjs} puts its ceiling at 98
with the plan the only thing standing between 51 and it — the compiler's
