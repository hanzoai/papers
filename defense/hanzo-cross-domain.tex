...
\item \textbf{Anchoring}: Record hash committed to the Hanzo chain via Quasar consensus.
...
\textbf{Source code.} \texttt{github.com/hanzoai/fhe, hanzoai/kms} (commit \texttt{TBD}).\\
\textbf{Build.} make build (Rust 1.78+, OpenFHE bindings); GPU NTT via Metal/CUDA.\\
\textbf{Hardware tested.} Apple M2/M3 (Metal), NVIDIA A100/H100.\\
\textbf{Standards referenced.} NIST FHE (BFV/BGV/CKKS/TFHE), HIPAA, SOX, SEC, MLS.\\
