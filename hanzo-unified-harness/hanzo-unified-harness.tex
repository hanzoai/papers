...
\author{
    Hanzo AI Research \\
    Hanzo AI Research\\
    \textit{Hanzo AI Inc (Techstars '17), San Francisco, CA}\\
...
\textbf{Source code.} \texttt{github.com/hanzoai/agents} (commit \texttt{TBD}); seven-layer reference impl across \texttt{hanzoai/engine}, \texttt{hanzoai/mcp}, \texttt{hanzoai/agents}, \texttt{hanzoai/base}.\\
\textbf{Build.} \texttt{make all} at repo root; integration via \texttt{kubectl kustomize universe/infra/k8s/ | kubectl apply -f -}.\\
\textbf{Hardware tested.} Apple M-series (Metal), Linux amd64/arm64 with NVIDIA A100/H100; tiered runtime validated on M2 Pro and H100.\\
\textbf{Standards referenced.} MCP, OpenAI tool-use API, SWE-bench evaluation protocol.\\
