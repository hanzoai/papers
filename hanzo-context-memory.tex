...
The multi-hop questions with Gemma say where the remaining error is. Cosine
...
The first run compiled plans with a hand-written lexicon. It scored 98.0 /
...
fails validation; both runs stand in Table~\ref{tab:mab}. The comparison
with CAR is on the same metric and haystacks; CAR's reader is gpt-4o-mini or
gpt-4o, and ours is either none or an open model, which is stated on every
row.
