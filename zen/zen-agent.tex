...
analysis, and scientific reasoning. The model achieves 64.6\% on GAIA (Level 1--3 average),
...
\textbf{Zen-Agent 32B} & \textbf{83.1} & \textbf{68.4} & \textbf{42.3} & \textbf{64.6} \\
\bottomrule
\end{tabular}
...
64.6\% GAIA and 42.8\% SWE-bench Verified, establishing a new state of the art for open
