% Kai: encoder, evidence adapters, decoder. Solid boxes are in the code; dashed are proposed.
\begin{figure}[t]
\centering
\begin{tikzpicture}[
  font=\footnotesize,
...
\node[prop, enc, right=of sen] (esen) {rate-aware adapter};
...
Evidence records are encoded once per change; options are encoded alone, narrowed by retrieval above $k$, and scored against the
