...
\textbf{Source code.} \texttt{github.com/hanzoai/kms, hanzoai/iam} (commit \texttt{TBD}).\\
\textbf{Build.} make build per component; integrated K8s deploy via kubectl kustomize.\\
\textbf{Hardware tested.} Linux amd64/arm64; HSM integration tested with PKCS\#11.\\
\textbf{Standards referenced.} NIST SP 800-207 (Zero Trust), Shamir SSS, FIPS 140-3.\\
