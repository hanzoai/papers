...
measure allocator and file-format behaviour, not silicon --- but the microVM
figure will not: \rVm{}\,ms is a hypervisor boot on macOS, and a native Linux
host with KVM does not pay the same costs. It is therefore likely
\emph{pessimistic} for our own cold-start row. We have not measured it natively
and do not claim the better number.
