...
\author{
    Antje Worring, Hanzo AI Research\thanks{research@lux.network} \\
...
\begin{itemize}
    ...
    \item Consensus engines - Quasar, BFT, DAG-based protocols
...
M.~Chen, J.~Tworek, H.~Jun, Q.~Yuan, H.~Pinto de~Oliveira, J.~Kaplan,
