...
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{hanzo-k8s} (4 worker nodes, v1.34.1):
...
channel-specific identities to canonical users through its identity
federation layer. All user data is encrypted at rest using Hanzo KMS
(\texttt{kms.hanzo.ai}, based on Infisical~\cite{infisical2023}).
