...
\author{
    Zach Kelling \and Hanzo AI Research Team\thanks{research@hanzo.ai} \and
...
\vspace*{\fill}
\begin{center}
\begin{minipage}{0.9\textwidth}\centering\makeatletter\fontsize{18}{22}\selectfont\bfseries\@title\makeatother\end{minipage}\par\vspace{1cm}
{\makeatletter\small\let\thanks\@gobble\begin{tabular}[t]{c}\@author\end{tabular}\makeatother}\\[0.5cm]
{\makeatletter\small\@date\makeatother}\\[2cm]
{\footnotesize Hanzo AI \hfill RESEARCH}
\end{center}
\vspace*{\fill}
\newpage
\pagecolor{white}
