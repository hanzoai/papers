...
D.~Mazi\`eres.
\newblock The {Stellar Consensus Protocol}: A federated model for
internet-level consensus.
\newblock \emph{Stellar Development Foundation}, 2015.
...
\bibitem{amsden2019libra}
Z.~Amsden, R.~Arber, M.~Baudet, et~al.
\newblock The {Libra} blockchain.
\newblock \emph{Libra Association}, 2019.

\bibitem{poon2017plasma}
J.~Poon and V.~Buterin.
\newblock Plasma: Scalable autonomous smart contracts.
\newblock \url{https://plasma.io/plasma.pdf}, 2017.

\bibitem{schwartz2014ripple}
D.~Schwartz, N.~Youngs, and A.~Britto.
\newblock The {Ripple} protocol consensus algorithm.
\newblock \emph{Ripple Labs Inc.}, 2014.
