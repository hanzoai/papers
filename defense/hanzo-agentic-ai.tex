...
\bibitem{lora} E. Hu \textit{et al.}, ``LoRA: Low-Rank Adaptation,'' ICLR 2022.

\bibitem{dpo} R. Rafailov \textit{et al.}, ``Direct Preference Optimization,'' NeurIPS 2023.

\bibitem{rlhf} L. Ouyang \textit{et al.}, ``Training Language Models to Follow Instructions with Human Feedback,'' NeurIPS 2022.

\bibitem{flashattn} T. Dao \textit{et al.}, ``FlashAttention-2,'' ICLR 2024.
