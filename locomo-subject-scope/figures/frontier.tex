...
that operating point the four arms lie within $0.009$ of each other on the
answerable half --- $0.142$, $0.144$, $0.144$ and \texttt{span}'s $0.151$,
against the dashed line at $0.143$ --- while the two subject-scoped indexes
reach $0.502$ and $0.352$ on the adversarial questions where the flat ones reach
$0.200$ and $0.170$.}
\label{fig:frontier}
\end{figure}
