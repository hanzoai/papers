...
all major 3D benchmarks: 92.2\% mean IoU on ShapeNet, 88.3\% mIoU on ScanNet semantic segmentation,
...
across 3D segmentation (ScanNet mIoU 88.3\%), reconstruction (ShapeNet mean IoU 92.2\%), and
