...
fails validation. That run scored 59 / 59 / 33 on multi-hop at 32K / 64K
/ 262K.
...
calls no model: the compiled plan is the only thing a model produced, once,
at temperature 0. On dev it moved multi-hop from 76 to 83 and single-hop
...
94 / 51 at 262K with no reader at all. The unsourced ``91 / 57'' is exceeded
