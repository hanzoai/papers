...
\midrule
\textbf{Average} & \textbf{56} & \textbf{67.1} & \textbf{65.0} & \textbf{+2.1} \\
\bottomrule
\end{tabular}
\end{table}
...
Zen Embed delivers state-of-the-art dense retrieval quality across English and multilingual benchmarks while remaining practically deployable through BitDelta-compatible compression. The 7,680-dimensional embeddings achieve 67.1 MTEB average and 54.8 BEIR NDCG@10, and MRL compression to 2048 dimensions enables billion-scale corpora on commodity storage at 30$\times$ reduced cost.
