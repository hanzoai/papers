...
\author{Antje Worring \and Hanzo AI Research\thanks{research@lux.network} \and Hanzo Industries \and Lux Industries \and Zoo Labs Foundation}
\date{September 2025}
...
\item Carbon Footprint: 0.8kg CO\textsubscript{2}/month per instance
