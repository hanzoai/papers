...
semantic-aware gradient compression that preserves model-semantic fidelity at 98.8\%
...
convergence matching centralized training with 99.94\% bandwidth reduction and robustness
...
The 98.8\% figure in the abstract is semantic Top-1\% against uncompressed FP32
all-reduce, 0.49 GB/s against 40.0. The DSO default adds INT8 and gossip for
1667$\times$, or 99.94\%, enabling training over 1Gb/s WAN links.
...
achieving 99.94\% bandwidth reduction with negligible convergence degradation ($\Delta\mathcal{L} \le 0.04$)
