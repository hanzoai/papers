...
\author{Hanzo AI Research\thanks{research@hanzo.ai} \\ \textit{Hanzo Industries (Techstars '17)} \\ \texttt{research@hanzo.ai}}
\date{March 2026}
...
\input{sections/23-named-competitor-scaffold}
\input{sections/99-conclusion}

\onecolumn
\section*{Reproducibility}
\textbf{Source code.} \texttt{github.com/hanzoai/platform} (commit \texttt{TBD}); component repos: \texttt{hanzoai/iam}, \texttt{hanzoai/gateway}, \texttt{hanzoai/base}, \texttt{hanzoai/kms}, \texttt{luxfi/crypto}, \texttt{luxfi/mpc}, \texttt{luxfi/fhe}.\\
\textbf{Build.} Per-component \texttt{make build}; integrated K8s deploy via \texttt{kubectl kustomize universe/infra/k8s/ | kubectl apply -f -}.\\
\textbf{Hardware tested.} Linux amd64/arm64; GPU acceleration on Apple Metal (M2/M3) and NVIDIA CUDA (A100/H100).\\
\textbf{Standards referenced.} OIDC, W3C DID, FIPS 203 (ML-KEM), FIPS 204 (ML-DSA), S3 API, OpenAI API.\\
