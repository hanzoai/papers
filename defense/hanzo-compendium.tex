...
\usepackage{bookmark}
\hypersetup{
  pdftitle={Hanzo Defense and Reindustrialization --- Paper Compendium},
  pdfauthor={Zach Kelling --- Hanzo Industries},
...
\thispagestyle{empty}
{\Large\bfseries Hanzo --- Defense \& Reindustrialization}\\[2pt]
{\large Paper Compendium}\\[1.5em]
{\footnotesize\color{gray}Sovereign AI, robotics, post-quantum, and on-chain coordination for the American
industrial base. Click any title to jump to the paper; the PDF bookmark sidebar also navigates the suite.
The full suite is published at papers.hanzo.ai.}\\[1.5em]
...
\hyperref[c01]{Sovereign vs.\ Closed --- owned AI vs.\ metered cloud}\\[0.3em]
...
Approved for public release; distribution unlimited. \quad research@hanzo.ai \quad papers.hanzo.ai}
\newpage
...
\includepdf[pages=-,fitpaper=true,addtotoc={1,section,0,{Sovereign vs. Closed},c01}]{hanzo-vs-claude.pdf}
