...
\begin{table}[H]
\centering
\caption{End-to-end inference throughput on NVIDIA GPUs. Single GPU, batch size
optimized per model per GPU. The quantization is the INT4 + FP16 configuration of
Table~\ref{tab:cumulative}, whose H100 MoDE-72B row is the 31,200 tok/s entry here.}
