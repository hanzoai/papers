...
comparison and a decision framework for when each model of consumption fits. We
also make the productivity case concrete: on a regulated capital-markets build
