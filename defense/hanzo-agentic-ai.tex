...
\bibitem{corona} ``Two-Round Threshold Signature from LWE,'' IACR ePrint 2024/1113.
...
\textbf{Build.} \texttt{pnpm install \&\& pnpm build} (Node 20+); SDK via \texttt{uv sync}.\\
\textbf{Hardware tested.} Apple M-series, x86\_64 Linux + NVIDIA A100/H100.\\
\textbf{Standards referenced.} W3C DID, OpenAI tool-use API, MCP, OpenTelemetry.\\
