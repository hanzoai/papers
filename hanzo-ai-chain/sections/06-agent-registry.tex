...
that produced finalized A-Chain receipts under the selected proof policy;
\texttt{volume} is total AI
...
zen-vision, spending 38.7 AI. Each call produces a PoAI-finalized receipt
