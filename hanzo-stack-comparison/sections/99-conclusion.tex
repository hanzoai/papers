...
\bibitem{langgraphgithub}
LangChain AI. \textit{LangGraph: Build resilient language agents as graphs}. \url{https://github.com/langchain-ai/langgraph}, 2024.

\bibitem{autogengithub}
Microsoft Research. \textit{AutoGen: Programming Framework for Agentic AI}. \url{https://github.com/microsoft/autogen}, 2023.

\bibitem{crewaigithub}
J.~Moura. \textit{CrewAI: Framework for orchestrating role-playing, autonomous AI agents}. \url{https://github.com/crewAIInc/crewAI}, 2023.

\bibitem{openaiagentssdk}
OpenAI. \textit{OpenAI Agents SDK (formerly Swarm)}. \url{https://github.com/openai/openai-agents-python}, 2024.

\bibitem{pecollective2026agentframeworks}
PE Collective. \textit{AI Agent Frameworks Compared: LangGraph vs CrewAI vs AutoGen (2026)}. \url{https://pecollective.com/blog/ai-agent-frameworks-compared/}, 2026.

\bibitem{pooya2026frameworks}
P.~Golchian. \textit{CrewAI vs LangGraph vs AutoGen 2026: Benchmarks, Pricing, and the Right Choice}. \url{https://pooya.blog/blog/crewai-vs-langgraph-autogen-comparison-2026/}, 2026.

\bibitem{vllmrepo}
vLLM Project. \textit{vLLM: A high-throughput and memory-efficient inference and serving engine for LLMs}. \url{https://github.com/vllm-project/vllm}, 2023.

\bibitem{vllmpaper}
W.~Kwon et al. \textit{Efficient Memory Management for Large Language Model Serving with PagedAttention}. SOSP 2023. arXiv:2309.06180.

\bibitem{tgirepo}
Hugging Face. \textit{text-generation-inference: Large Language Model Text Generation Inference}. \url{https://github.com/huggingface/text-generation-inference}, 2023.

\bibitem{tensorrtllm}
NVIDIA. \textit{TensorRT-LLM: Optimised inference toolkit for LLMs}. \url{https://github.com/NVIDIA/TensorRT-LLM}, 2023.
