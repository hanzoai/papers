...
\bibitem{rfc9180} R. Barnes \textit{et al.}, ``Hybrid Public Key Encryption,'' RFC 9180, 2022.

\bibitem{tfhe} I. Chillotti \textit{et al.}, ``TFHE: Fast Fully Homomorphic Encryption,'' JoC, 2020.

\bibitem{bfv} J. Fan, F. Vercauteren, ``Somewhat Practical Fully Homomorphic Encryption,'' IACR ePrint 2012/144.

\bibitem{ckks} J. Cheon \textit{et al.}, ``Homomorphic Encryption for Arithmetic of Approximate Numbers,'' ASIACRYPT 2017.
