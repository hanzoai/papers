...
Corona threshold & \texttt{lux/crypto/threshold/} & Malformed share acceptance \\
...
\begin{itemize}
\item \textbf{No Snow-family TLA+ spec exists} anywhere. Amores-Sesar \textit{et al.}\ (2024) provided the first formal consistency proof of Snowman, but no TLA+ model has been published.
...
\bibitem{apalache} I. Konnov \textit{et al.}, ``TLA+ Model Checking Made Symbolic,'' OOPSLA 2019.

\bibitem{tamarin} S. Meier \textit{et al.}, ``The TAMARIN Prover for the Symbolic Analysis of Security Protocols,'' CAV 2013.

\bibitem{tendermint-tla} I. Braithwaite \textit{et al.}, ``Formal Specification and Model Checking of Tendermint,'' FMBC 2020.

\bibitem{snow-formal} B. Amores-Sesar \textit{et al.}, ``An Analysis of Avalanche Consensus,'' arXiv:2401.02811, 2024.
...
\bibitem{dudect} O. Reparaz \textit{et al.}, ``dudect: A Leakage Detection Tool,'' CHES 2017.
