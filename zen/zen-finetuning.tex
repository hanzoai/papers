...
98.3\% of full fine-tuning performance at 0.8\% of the trainable parameters; (2)
...
and compute budgets. LoRA rank 64 over the attention projections achieves
98.3\% of full fine-tuning performance at 0.8\% of parameters, making it the
