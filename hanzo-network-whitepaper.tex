% Hanzo Network Whitepaper — Hamiltonian Market Maker (HMM) L1 for AI Compute
...
\author{
    Antje Worring, Hanzo AI Research\textsuperscript{1,2,3}\thanks{Corresponding author: research@hanzo.ai} \\
    \\
...
\end{equation}
Scales are distilled by matching logits to a teacher rollout. BitDelta reports \(\approx 29.5\times\) storage savings with negligible loss in downstream utility, enabling multi-tenant caching and rapid hot-swaps of personalizations.
...
\newblock \emph{Bittensor Foundation Whitepaper}, 2021.

\bibitem{filecoin2017}
{Protocol Labs}.
\newblock {Filecoin}: A decentralized storage network.
\newblock \url{https://filecoin.io/filecoin.pdf}, 2017.

\bibitem{liu2024bitdelta}
J.~Liu, N.~B.~Desai, R.~Agarwal, and B.~Lester.
...
\newblock \emph{Uniswap Labs}, 2021.

\bibitem{costan2016sgx}
V.~Costan and S.~Devadas.
\newblock Intel {SGX} explained.
\newblock \emph{IACR Cryptology ePrint Archive}, 2016/086, 2016.
