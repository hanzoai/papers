...
reach almost every annotated turn of both kinds. The two subject-scoped indexes
give up a fifth to a quarter of the answerable evidence and two-thirds to
three-quarters of the adversarial evidence: they are selectively blind, and the
blindness falls where the trap turns are. \texttt{oracle} is handed the
