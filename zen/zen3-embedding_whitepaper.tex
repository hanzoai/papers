...
for efficient deployment. At 7B parameters, Zen3-Embedding achieves MTEB average 67.4\%,
BEIR nDCG@10 57.8\% and MIRACL 81.2\%, surpassing prior
...
\textbf{MTEB Average} & \textbf{67.4} & \textbf{63.6} & 56 \\
\bottomrule
\end{tabular}
\label{tab:mteb}
\end{table}
...
protocol compatibility, achieving MTEB 67.4\%, BEIR 57.8\%, and MIRACL 81.2\%.
