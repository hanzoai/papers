...
\begin{table}[H]
\centering
\caption{First-Token Latency Benchmarks (single H100 80GB GPU, FP8).
The 98ms P95 here is the cloud configuration of Table~\ref{tab:zenlive-deploy};
the A10G edge configuration measures 113ms.}
\begin{tabular}{lcccc}
\toprule
