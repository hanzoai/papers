...
\textbf{Source code.} \texttt{github.com/hanzoai/agents} (commit \texttt{TBD}); GRPO loop in \texttt{python/hanzo\_harness/grpo}.\\
\textbf{Build.} \texttt{uv sync \&\& pytest tests/grpo}; reference rollouts use Zen-Nano via \texttt{hanzo-engine}.\\
\textbf{Hardware tested.} Apple M2/M3 (Metal); x86\_64 Linux with NVIDIA A100/H100 for batch evaluations.\\
\textbf{Standards referenced.} OpenAI tool-use API, MCP, GRPO (DeepSeek R1 family).\\
