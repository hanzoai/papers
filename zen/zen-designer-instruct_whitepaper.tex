...
CLIP score and FID are not reported. Both are computed over images a model
generates, and this model takes an image and returns text.
...
\midrule
FP16 & 470 GB & 6x A100 80GB \\
INT8 & 235 GB & 3x A100 80GB \\
INT4 & 118 GB & 2x A100 80GB \\
\bottomrule
\end{tabular}
