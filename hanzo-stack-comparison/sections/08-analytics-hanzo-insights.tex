...
Hanzo Insights is a fork of Umami adapted for the Hanzo platform. It provides privacy-first web and product analytics with no cookies, no personal data collection, and full GDPR/CCPA compliance by design. Data is stored in Hanzo Datastore, our Apache-2.0 ClickHouse fork, for high-throughput analytical queries.
